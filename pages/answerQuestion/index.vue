<template>
	<view class="uni-flex uni-column answerquestion">
			...
			<div class="headWrap">
				<view class="flex p-xs mb-sm" style="padding-top:5vh;">
					...
					<view class="flex-twice" style="padding-top: 13px;">
						<view class="cu-progress striped radius">
						...
						<ol>
							<view v-for="(item, index) in items" :key="index">
								<li class="uni-list-cell" :style="{ background: item.background }">
									...
									<view>
										<radio color="#ff6671" :value="item.value" :checked="item.checked" />
									</view>
								</li>
							</view>
						</ol>
		...
		<view v-if="initUserQuestionsPayInfo">
			<report-result-popup :initUserQuestionsPayInfo="initUserQuestionsPayInfo" :show="showReport" />
		</view>
	</view>
</template>
