	...
	<view class="search" :style="{ backgroundColor: backgroundColor }">
		<view class="content" :style="{ 'border-radius': radius + 'px', border: border }">
			<view class="content-box" :class="{ center: mode === 2 }">
				...
				<input class="input" disabled="disabled" :class="{ center: !active && mode === 2 }" :focus="isFocus" :placeholder="placeholder" v-model="inputVal" @click="inputClick" @focus="focus" @blur="blur" />
...
export default {
	props: {
		...
		border: { type: String, default: '1px solid rgb(153, 153, 153)' },
		onInputClick:{
			type:Function,
			default:function(){}
		}
